...
#             #salary=vacancy["salary"]["from"] if vacancy.get("salary") else "Зарплата не указана",
...
#  данная функция работала но ошибка mypy
# def user_interaction() -> None:
#     """Функция для взаимодействия с пользователем через консоль."""
#
#     search_query = input("Введите поисковый запрос: ").strip()
...
#             salary_value = salary.get("from") if salary.get("from") is not None else "Зарплата не указана"
#         else:
#             salary_value = salary
#
#         # Проверка на тип перед передачей в Vacancy
...
#                     title=vacancy["title"],
#                     link=vacancy["link"],
#                     salary=salary_value,  # Передаем корректное значение зарплаты
#                     description=vacancy["description"]
#                 ).to_dict()
#             )
...
# данный код работал все отрабатывал и mypy тоже
# def user_interaction() -> None:
#     """Функция для взаимодействия с пользователем через консоль."""
#
#     search_query = input("Введите поисковый запрос: ").strip()
